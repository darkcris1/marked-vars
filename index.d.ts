...
export as namespace markedVars

export = markedVars

type result = { vars: object; html: string }
/**
 ...
 */
declare function markedVars(
  src: string,
  options?: markedVars.MarkedOptions,
): result
...
declare namespace markedVars {
  const defaults: MarkedOptions

  /**
   *
   * @param variables Object variables of markdown
   * @param markdown String markdown
   *
   * @example
   * markedVars({title: "Movies"}, "# Hello world")
s   */
  function convertToMarkdown(
    variables: object,
    markdown: string,
    delims: MarkedOptions.delims,
  ): string
   ...
   * @param options Hash of options
   */
  function options(options: MarkedOptions): typeof markedVars
   ...
   * @param options Hash of options
   */
  function setOptions(options: MarkedOptions): typeof markedVars
  ...
  class Tokenizer {
    ...
    ): Tokens.Link | Tokens.Image | Tokens.Text
  ...
  interface MarkedOptions {
    ...
    xhtml?: boolean
    /**
     * Open and closing tag of variables
     * @default ["---vars","----"]
     */
